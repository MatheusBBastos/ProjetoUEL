...
int main(int argc, char* argv[]) {
    if(!initialize()) {
        ...
        gInfo.lobbyFontd = TTF_OpenFont("content/Minecraft.ttf", 56 * gInfo.screenMulti);
        gInfo.lobbyFonte = TTF_OpenFont("content/Minecraft.ttf", 48 * gInfo.screenMulti);
        gInfo.lobbyName = TTF_OpenFont("content/Minecraft.ttf", 61 * gInfo.screenMulti);
